...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        # print('target ', target , ' ... ')
        print("imggg:",image_id)
        print("points_super::",points_supervision)
...
def build(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train2017", root / "annotations" / f'{mode}_train2017_with_points_our.json'),
        "val": (root / "val2017", root / "annotations" / f'{mode}_val2017_with_points_our.json'),
    }
